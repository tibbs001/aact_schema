...
namespace :db do
  def set_search_path
    ...
    con.execute("alter role ctti set search_path to ctgov, support, admin, public;")
    ...
    con.execute("grant usage on schema admin to ctti;")
    con.execute("grant create on schema admin to ctti;")
    con.reset!
  end
